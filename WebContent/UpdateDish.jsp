...
<body>
	...
	<div id="content">
		<form method="post" action="AddDish" id="reservationConfirm" onsubmit="event.preventDefault(); validateMyForm();" style="background-image: url('${pageContext.request.contextPath}/images/tables/${table.tableImage}');">
			<div id="reservationInfo">
				<h2>Update Dish</h2>
			</div>
			<div id="customerInfo">
				<h2>Dish Information</h2>
				<input  type="text" id="dishName" name="dishName" placeholder="Full Name (Ex: Thịt gà)">
				<input  type="number" id="dishType" name="dishType" placeholder="Type (Ex: 1)">
				<input type="number" id="dishPrice" name="dishPrice" placeholder="Price (Ex: 100.000)">
				<input type="number" id="dishId" name="disId" placeholder="ID (Ex: 2)">				
