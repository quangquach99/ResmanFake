...
<body>
	...
	<div id="content">
		<form method="post" action="AddDish" id="reservationConfirm"
			...
			<div id="customerInfo">
				...
				<input type="text" id="dishName" name="dishName"
					placeholder="Full Name (Ex: Thịt gà)"> <input type="number"
					id="dishType" name="dishType" placeholder="Type (Ex: 1)"> <input
